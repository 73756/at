    ...
    <div style={{ backgroundColor: '#f2f2f2' }}>
      ...
      <div style={{ padding: '16px' }}>
        ...
        <section style={{ display: 'flex' }}>
          <div style={{ flex: 1 }}>
            <h2 style={{ textAlign: 'center', fontFamily: 'Arial', fontSize: '20px' }}>Vendas</h2>
            {salesData && (
          ...
          <div style={{ flex: 1 }}>
            <h2 style={{ textAlign: 'center', fontFamily: 'Arial', fontSize: '20px' }}>Métodos de Pagamento</h2>
            {paymentMethodsData && (
        ...
        <section style={{ display: 'flex' }}>
          <div style={{ flex: 1 }}>
            <h2 style={{ textAlign: 'center', fontFamily: 'Arial', fontSize: '20px' }}>Produtos</h2>
            {productsData && (
              <BarChart width={500} height={300} data={productsData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="quantidade" fill="#FF5722" name="Quantidade" />
              </BarChart>
            )}
          </div>

          <div style={{ flex: 1 }}>
            <h2 style={{ textAlign: 'center', fontFamily: 'Arial', fontSize: '20px' }}>Região de Vendas</h2>
            {regionData && (
              <PieChart width={500} height={300}>
                <Pie
                  data={regionData}
